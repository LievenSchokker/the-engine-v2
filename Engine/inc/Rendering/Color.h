...
struct Color
{
    ...
    constexpr Color(uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha = 255) : r(red), g(green), b(blue), a(alpha)
    {
    }
    ...
    static Color fromRGBA(uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha = 255);
