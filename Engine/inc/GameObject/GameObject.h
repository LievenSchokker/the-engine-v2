...
class GameObject
{
   public:
	 ...
	 *
	 * @c isDestroyed will be set to true, but the object and its components
	 * will be destroyed by the @c scene this object belongs to.
	 *
	 */
	void destroy();

	/**
	 * Called by @c scenePlaceholder after this GameObject has been marked for
	 * destroyment by @c destroy()
	 */
	void onSceneDestroy();
	 ...
	 *
	 * Use this to determine if a GameObject is still present in memory, but
	 * should be removed at the end of the frame.
	 ...
	 *
	 * This establishes a parent-child relationship. The child's transform will
	 * be relative to the parent's transform. Setting a parent will update the
	 * child's Transform to reference the parent's Transform.
	 *
	 * @param parent The parent GameObject, or nullptr to remove the parent
	 * relationship.
	 */
	 ...
	 * @return Pointer to the parent GameObject, or nullptr if no parent.
	 */
	GameObject* getParent() const;

	/**
	 * @brief Gets all direct children of this GameObject.
