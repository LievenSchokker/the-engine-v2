...
#include "Behaviours/TransformShooter.h"
...
std::unique_ptr<Scene> TransformZandbak::getScene()
{

    /// Player:
    auto player = std::make_unique<GameObject>();
    auto renderer = player->addComponent<ShapeRenderer>();
    renderer->setRectangle({50, 40});
	...
	player->addComponent<TransformShooter>();
    ...
    auto scene = std::make_unique<Scene>("TransformZandbak");
