...
int main()
{
    ...
    SDL_Window* window = SDL_CreateWindow(
        "Basic C++ SDL project", SDL_WINDOWPOS_UNDEFINED,
    ...
    std::cout << "- Press W and A to see if they are currently held"
              << std::endl;
    std::cout
        << "- Press the left mouse button and the right mouse button to see if "
    ...
    std::cout << "- Move the mouse to see if it moved this frame and is close "
              ...
              << std::endl;
    std::cout << "- Scroll the mouse wheel to see if the wheel delta is not 0"
              << std::endl;
    ...
    while (running)
    {
        ...
        // ================================
        {
            ...
            // =================================================================================
            if (input->mouseMovedThisFrame() && input->mouseX() < 20 &&
                input->mouseY() < 20)
            {
            ...
            {
                std::cout << "Mouse wheel delta: (" << input->wheelDeltaX()
                          << ", " << input->wheelDeltaY() << ")" << std::endl;
            }
            // =================================================================================
