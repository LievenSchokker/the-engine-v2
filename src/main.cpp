...
int main()
{
    ...
    std::cout << "- Press the left mouse button and the right mouse button to see if they are currently held and if the right mouse button was "
                 "pressed"
              << std::endl;
    std::cout << "- Move the mouse to see if it moved this frame and is close to the top left corner (x < 20 && y < 20)" << std::endl;
    ...
    while (running)
    {
        ...
        // ================================ GAME CODE CHECK ================================
        {
            ...
            {
                std::cout << "Left mouse button is currently held and right mouse button was pressed (game code check)" << std::endl;
            }
            // =================================================================================
            if (input->mouseMovedThisFrame() && input->mouseX() < 20 && input->mouseY() < 20)
            {
                std::cout << "Mouse moved this frame and is close to the top left corner (game code check)" << std::endl;
            }
            // =================================================================================
