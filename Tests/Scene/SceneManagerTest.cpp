...
TEST(SceneManagerTest, TransferGameObject)
{
	...
	EXPECT_EQ(sceneManager.getScene("Scene1")->getGameObject("Player"),
			  nullptr);

	// Act - Activate Scene2
	sceneManager.setActiveScene("Scene2");

	// Assert - Object should be started when scene becomes active
	...
	// Assert - Object should be stopped when transferred from active scene
...
TEST(SceneManagerTest, TransferGameObjectErrorCases)
{
	...
	// Act & Assert
	EXPECT_FALSE(
		sceneManager.transferGameObject("Scene1", "NonExistent", "Player"));
	EXPECT_FALSE(
		sceneManager.transferGameObject("NonExistent", "Scene2", "Player"));
	EXPECT_FALSE(
		sceneManager.transferGameObject("Scene1", "Scene2", "NonExistent"));
