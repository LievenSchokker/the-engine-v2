...
TEST_F(AnimationClipTest, AddTrackUpdatesLength)
{
	...
	AnimationTrack track1(TargetType::Transform,
	...
	AnimationTrack track2(TargetType::Transform,
	                      PropertyType::Position,
	                      5.0f,
	                      false,
	                      fromPos,
	...
	// Tracks with the same property are sequential, so length is sum (2.0 + 5.0 = 7.0)
