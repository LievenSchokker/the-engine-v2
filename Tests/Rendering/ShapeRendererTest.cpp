...
TEST(ShapeRendererTest, FillsQueueWithCircleCommand)
{
    ...
    scene.addRunTimeGameObject(std::move(circle));
...
TEST(ShapeRendererTest, FillsQueueWithRectangleCommand)
{
    ...
    scene.addRunTimeGameObject(std::move(rect));
...
TEST(RenderSystemTest, ExecutesCommandsThroughRenderer)
{
    ...
    scene->addRunTimeGameObject(std::move(circle1));
    ...
    scene->addRunTimeGameObject(std::move(circle2));
...
TEST(RenderSystemTest, SkipsInactiveGameObjects)
{
    ...
    scene->addRunTimeGameObject(std::move(activeObj));
    ...
    scene->addRunTimeGameObject(std::move(inactiveObj));
